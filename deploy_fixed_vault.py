...
# Solc 0.8.20 compiled bytecode for robust state store
bytecode = (
    ...
    "02179055506101a78061005f6000396000f3fe608060405234801561001057600080fd5b6004"
    ...
    "5b005b610085610110565b604051610092919061012f565b60405180910390f35b6100a3610116"
    "565b6040516100b0919061014e565b60405180910390f35b6000805473ffffffffffffffffff"
...
print(f"[+] Fresh Vault Address: {receipt.contractAddress}")

# Auto-update keeper.py
with open("keeper.py", "r") as f:
    code = f.read()

updated = re.sub(
    r'VAULT_ADDRESS = Web3\.to_checksum_address\("0x[a-fA-F0-9]{40}"\)',
    f'VAULT_ADDRESS = Web3.to_checksum_address("{receipt.contractAddress}")',
    code
)
